...
combined_documents = utils.combine_documents(oil_gas=False)
...
## Automatic
attention_dict_automatic = utils.create_attention_dict(filtered_iea_10K_top200words, combined_documents)
...
# Display
utils.display_results(final_df_automatic, wd, oil_gas=False, manual=False)

utils.display_results(final_df_manual, wd, oil_gas=False, manual=True)
